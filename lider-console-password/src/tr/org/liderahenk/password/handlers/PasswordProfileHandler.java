...
import tr.org.liderahenk.password.dialogs.PasswordProfileDialog;
...
/**
 * Profile definition handler for password plugin.
 *
 */
public class PasswordProfileHandler extends AbstractHandler {

	private Logger logger = LoggerFactory.getLogger(PasswordProfileHandler.class);
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        try {
			...
			page.openEditor(new ProfileEditorInput(Messages.getString("Password"), PasswordConstants.PLUGIN_NAME, 
					PasswordConstants.PLUGIN_VERSION, new PasswordProfileDialog()), 
